...
import { X, CheckCircle, DollarSign, Calendar, CreditCard, FileText, TrendingUp } from 'lucide-react'
        ...
        <div>
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            <input
              ...
              step="0.01"
              value={valorRecebido}
              onChange={(e) => setValorRecebido(parseFloat(e.target.value))}
              disabled={loading}
              style={{
                width: '100%',
                padding: '12px',
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            >
              ...
              <option style={{ background: '#1f2937' }}>Transferência</option>
